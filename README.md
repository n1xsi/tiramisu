...
Пока проект в разработке, вы можете запустить свой рецепт через встроенный транспайлер:
...
* [ ] Import Hooks: возможность напрямую импортировать .tira файлы внутри других скриптов
* [ ] CLI (Интерфейс командной строки) — Удобный запуск через команду tiramisu run ...
