...
VOCABULARY = {
    ...
    # Модули и пакеты
    # ---------------------------------------------------------
    'cookbook': '__name__',  # Книга рецептов (имя модуля)
    'pantry': '__file__',  # Кладовая (путь к файлу)
    'kitchen': '__main__',  # Кухня (главный модуль)
    'ingredients': '__dict__',  # Ингредиенты (атрибуты объекта)
    'platter': '__str__',  # Подача на блюде (строковое представление)
}
